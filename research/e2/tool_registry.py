...
def read(name: str, op: str, path: str, params: list[ToolParameter], *, scope: str = "resource", identity: bool = False) -> ToolSpec:
    return ToolSpec(name=name, operation_id=op, method="GET", path_template=path, kind=ToolKind.READ, parameters=params, target_scope=scope, identity_required=identity)
