...
class TraceEvent(ExtraForbidModel):
    ...
    event_type: Literal[
        "run_started", "model_call", "decision", "tool_proposal", "policy_check",
        "confirmation", "tool_call", "tool_result", "observation", "state_change",
        "escalation", "final_response", "error", "run_finished",
    ]
