...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Issue a short-lived provider-free D02 authorization receipt.")
...
def main() -> None:
    ...
    try:
        ...
        receipt = issue_d02_operator_attestation_receipt(
            evidence,
    ...
    payload = json.dumps(receipt.model_dump(mode="json"), sort_keys=True, separators=(",", ":"), ensure_ascii=False) + "\n"
    try:
    ...
    print(json.dumps({
        "status": "D02_OPERATOR_ATTESTATION_RECEIPT_ISSUED",
        ...
        "maximum_packet_neurons": receipt.maximum_packet_neurons,
        "minimum_free_neurons_before_attempt_1": receipt.minimum_free_neurons_before_attempt_1,
