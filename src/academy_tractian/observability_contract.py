...
class ObservabilityStoreContract(Protocol):
    """Durable browser-safe observability/evaluation projection contract.

    Implementations may use any managed persistence engine. The product layer depends only on
    this sanitized contract and therefore does not import a local database implementation.
    """
