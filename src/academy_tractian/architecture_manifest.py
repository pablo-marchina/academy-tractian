...
def _components() -> tuple[ArchitectureComponent, ...]:
    return (
        ...
        ArchitectureComponent(
            ...
            label="Product API",
            layer="api",
            responsibility="Resolve trusted server-side context, accept runs, and own process execution lifecycle.",
        ...
        ArchitectureComponent(
            ...
            layer="runtime",
            responsibility="Prepare one-shot production runs and compose the accepted controller/tool boundary with safe telemetry.",
            trust_boundary="runtime-owned identity and seed boundary",
            input_contracts=("ProductionRequest",),
        ...
        ArchitectureComponent(
            ...
            layer="runtime",
            responsibility="Produce typed controller decisions without owning tool execution, identity, seed, or evaluator state.",
        ...
        ArchitectureComponent(
            ...
            layer="runtime",
            responsibility="Run the bounded single-agent decision loop and terminate with final, clarify, escalate, or abstain outcomes.",
        ...
        ArchitectureComponent(
            ...
            layer="runtime",
            responsibility="Return controller-visible observations while keeping browser telemetry limited to safe evidence references.",
        ...
        ArchitectureComponent(
            ...
            layer="runtime",
            responsibility="Maintain ordered immutable operational provenance for the production run.",
            trust_boundary="raw runtime trace; never browser serialized",
        ...
        ArchitectureComponent(
            ...
            label="DuckDB Safe Read Model",
            layer="observability",
            responsibility="Persist only sanitized run, event, evidence, and evaluation projections for historical and realtime queries.",
            trust_boundary="persistent sanitized telemetry boundary",
            input_contracts=("SafeRun", "SafeEvent", "SafeEvidenceRef", "SafeEvaluation"),
            output_contracts=("Sanitized query rows",),
            activates_on_event_types=(
                "run_started",
                "model_call",
                "decision",
        ...
        ArchitectureComponent(
            ...
            layer="api",
            responsibility="Serve safe historical telemetry, health state, architecture metadata, and persisted SSE catch-up to the frontend.",
            trust_boundary="browser-facing sanitized API boundary",
            input_contracts=("Sanitized query rows",),
...
def _edges() -> tuple[ArchitectureEdge, ...]:
    return (
        ArchitectureEdge(source="operator_frontend", target="product_api", label="RunSubmission"),
        ...
        ArchitectureEdge(source="safety_envelope", target="tractian_transport", label="Authorized BoundRequest"),
        ...
        ArchitectureEdge(source="observability_store", target="observability_api", label="Sanitized query / catch-up"),
