...
Interpretation: E10f fixes the visible DEV safety side but overblocks. It is not a promotion candidate because the private scorer expects the DEV action capability to be preserved.
...
- [x] E10e full result recorded as not promotable because premature action remains 0.25.
