...
| [`008-provider-model-comparison-design-2026-08-28.md`](008-provider-model-comparison-design-2026-08-28.md) | P0 production provider/model comparison design | exact provider-free comparison candidate set, public DEV probes, hard gates, M1–M10, 32-call future budget and deterministic `NO_SELECTION` rule frozen; live calls and provider selection remain separately governed and unauthorized |
| [`009-provider-http-clients-live-comparison-authorization-2026-08-28.md`](009-provider-http-clients-live-comparison-authorization-2026-08-28.md) | P0 concrete provider clients + bounded live-comparison authorization | SDK-free OpenAI/Gemini clients and exact 32-call production-comparison envelope frozen; authorization becomes effective only after exact final-head provider-free validation; execution and provider selection remain separate |
| [`010-provider-comparison-executor-2026-08-28.md`](010-provider-comparison-executor-2026-08-28.md) | P0 provider/model comparison execution + evidence boundary | exact provider-free 32-attempt executor, public rubric adjudication, M1–M10 aggregation and deterministic `NO_SELECTION`-capable selection logic frozen; no live call consumed and no provider selected |
